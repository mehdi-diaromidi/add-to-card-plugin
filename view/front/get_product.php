...
function wp_atc_get_products(): void
{
    ...
    if (empty($cart_data)) {
        Message::wp_atc_send_json_message('error', 'کاربر گرامی، سبد خرید شما خالی است!', 403);
        return;
    }
        ...
        <div class="atc-product-card" data-atc-product-id="' . esc_attr($product_id) . '">
            ...
            <div class="atc-product-column atc-product-info-col">
                ...
                <div class="atc-product-price-info">
                    <div class="atc-product-price-container">
                        <span class="atc-product-price">' . esc_html($price) . ' </span>
                        <span class="atc-pmenu_product_currency">تومان</span>
                    </div>
                </div>
            </div>
            <div class="atc-product-column atc-product-actions-col">
                <div class="atc-product-add-to-cart-buttons atc-cart-actions">
                    <div class="atc-loop-increase-decrease">
                        <span class="atc-quantity-updator-buttons">
                            <button class="atc-quantity-updator-button atc-quantity-updator-button-increase" data-type="increase" data-atc-product-id="' . esc_attr($product_id) . '">
                                <i class="fa fa-plus"></i>
                            </button>
                            <span class="atc-quantity-display-quantity atc-cart-quantity-display-quantity" inputmode="numeric" data-atc-product-id="' . esc_attr($product_id) . '">' . esc_html($product_quantity) . '</span>
                            <button class="atc-quantity-updator-button atc-quantity-updator-button-decrease" data-type="decrease" data-atc-product-id="' . esc_attr($product_id) . '">
