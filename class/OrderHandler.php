...
class OrderHandler
{
    ...
    // Create a new order post and return the order ID
    ...
    // Update the amount of materials for a given material ID
    ...
    // Update the amount of product materials and return whether the update was successful
